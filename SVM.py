#creazione di file input per SVM
import sys
import os
import numpy as np
...
def SVM_input(profile1, dssp1, n):
	...
	for e in range(0,P):						#forse era range(0,P+1)
		if dssp_ok[e] == 'H':
...
if __name__ == '__main__':
	...
	with open(fileid) as filein:
		for ids in filein:
			ids=ids.rstrip()
#			profile_file = '/home/tommaso/Desktop/LB2_keys/keys/project/jpred_pssm/' + ids + '.fasta.pssm'		#jrped e cv
#			dssp_file = '/home/tommaso/Desktop/LB2_keys/keys/project/dssp/' + ids + '.dssp'
			profile_file = '/home/tommaso/Desktop/LB2_keys/keys/project/Blind-Set_pssm/'+ids+'.dssp.fasta.pssm'	#blind-pred
			dssp_file = '/home/tommaso/Desktop/LB2_keys/keys/project/150Random_DSSPs_dssp/'+ids+'.ss.dssp'
			try:
