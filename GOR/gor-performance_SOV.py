...
if __name__ == '__main__':
	...
	with open(IdsPredFile) as filein:
		...
		for id in filein:
			tot_prot += 1
			id = id.rstrip()
			observed_SecStr = '/home/tommaso/Desktop/LB2_keys/keys/project/150Random_DSSPs_dssp/' + id + '.ss.dssp'
			predicted_SecStr = '/home/tommaso/Desktop/LB2_keys/keys/project/GOR/gor_blind_predictions/SS-prediction_' + id + '.dssp'
