...
def SOV(seq_o, seq_p, SegFind_out):
	...
	l_maxov = [maxov_H, maxov_E, maxov_C]					#lista di liste contenenti vari maxov
	l_minov = [minov_H, minov_E, minov_C]					#lista di liste contenenti vari minov [n nelle ss = a maxov]
	l_len_o = [len_S_o_H, len_S_o_E, len_S_o_C]				#lista di liste contenenti le lunghezze dei vari frammenti presenti nei minov in OBS
	l_len_p = [len_S_p_H, len_S_p_E, len_S_p_C]				#lista di liste contenenti le lunghezze dei vari frammenti presenti nei minov in PRED
	l_half_len_o = [half_len_S_o_H, half_len_S_o_E, half_len_S_o_C]		#lista di liste contenenti le lunghezze/2 dei vari frammenti presenti nei minov in OBS
	l_half_len_p = [half_len_S_p_H, half_len_S_p_E, half_len_S_p_C]		#lista di liste contenenti le lunghezze/2 dei vari frammenti presenti nei minov in PRED [n nelle ss = ai precedenti 3]
...
if __name__ == '__main__':
	...
	with open(IdsPredFile) as filein:
		...
		for id in filein:
			tot_prot += 1
			id = id.rstrip()
			#observed_SecStr = '/home/tommaso/Desktop/LB2_keys/keys/project/dssp/' + id + '.dssp'
			observed_SecStr = '/home/tommaso/Desktop/LB2_keys/keys/project/150Random_DSSPs_dssp/'+id+'.ss.dssp'	#for blind
			#predicted_SecStr = '/home/tommaso/Desktop/LB2_keys/keys/project/models_for_CV/test0/predicted_seqs_4_2/'+ id + '.seqs'
			predicted_SecStr = '/home/tommaso/Desktop/LB2_keys/keys/project/SVM/for_project/final_predicted_sequences/'+id+'.seqs' #for blind
